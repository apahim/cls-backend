-- Simplified CLS Backend Database Schema
-- This migration contains the complete schema without organization multi-tenancy
-- Includes: clusters, nodepools, status tracking, cluster-centric reconciliation
-- Access control: Simple created_by field for future external authorization integration
...
CREATE TABLE IF NOT EXISTS clusters (
    ...
    name VARCHAR(255) NOT NULL UNIQUE,  -- Global unique cluster names
    target_project_id VARCHAR(255),
    created_by VARCHAR(255) NOT NULL,   -- For future external authorization
